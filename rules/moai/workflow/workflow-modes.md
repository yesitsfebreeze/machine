...
The Run Phase adapts its workflow based on `quality.development_mode` in `.proj/config/sections/quality.yaml`:
...
- Manual edit: Edit `quality.development_mode` in `.proj/config/sections/quality.yaml`
