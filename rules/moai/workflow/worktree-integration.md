...
**MoAI Worktree** (`~/.proj/worktrees/{ProjectName}/`):
...
|---------|--------------|------|
| **Path** | `.claude/worktrees/<name>/` | `~/.proj/worktrees/{Project}/{SPEC}/` |
...
| SPEC documents | `.proj/specs/SPEC-XXX/spec.md` | Relative preferred | SPEC files are copied to worktree during checkout |
...
| Run | MoAI | `~/.proj/worktrees/{Project}/{SPEC}/` |
