---
paths: "**/.proj/specs/**,**/.proj/config/sections/quality.yaml"
---
...
Output:
- Research document at `.proj/specs/SPEC-XXX/research.md` (deep codebase analysis)
- SPEC document at `.proj/specs/SPEC-XXX/spec.md`
...
Detection method:
- Append acceptance criteria completion count and error count delta to `.proj/specs/SPEC-{ID}/progress.md` at the end of each iteration
...
- `workflow.team.enabled: true` in `.proj/config/sections/workflow.yaml`
