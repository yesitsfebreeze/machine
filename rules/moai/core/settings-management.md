---
paths: "**/.proj/config/**,**/.mcp.json,**/.claude/settings.json,**/.claude/settings.local.json"
---
...
`.proj/config/` - MoAI-specific settings:
...
Team behavior is controlled by the `workflow.team` section in `.proj/config/sections/workflow.yaml`:
