# Foundation Core - Modules Directory

Purpose: Extended documentation modules for foundation-core skill, providing deep dives into each foundational principle.
...
This directory contains 9 comprehensive modules covering the machine's foundational principles and execution rules:
...
Quick Access:
- SPEC generation (the machine:1-plan)
- EARS format patterns
- DDD implementation (the machine:2-run)
- Documentation sync (the machine:3-sync)
...
Agent Catalog - Complete reference of the machine's 26 specialized agents with 7-tier hierarchy.
...
Command Catalog - Complete reference for the machine's 6 core commands in SPEC-First DDD workflow.

Quick Access:
- the machine:0-project (Project init)
- the machine:1-plan (SPEC generation)
- the machine:2-run (DDD implementation)
- the machine:3-sync (Documentation)
- the machine:9-feedback (Improvement)
- the machine:99-release (Deployment)
...
skill_path = Path(".claude/skillsthe machine-foundation-core")
...
class ModuleSearch:
 ...
 modules_dir = Path(".claude/skillsthe machine-foundation-core/modules")
 results = []
...
Skills:
- foundation-core (parent skill)
- cc-skill-factory (skill creation)
- core-agent-factory (agent creation)
...
Commands:
- the machine:1-plan (SPEC-First DDD)
- the machine:2-run (DDD implementation)
- the machine:3-sync (Documentation)
