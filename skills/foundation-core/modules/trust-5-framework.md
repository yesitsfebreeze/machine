...
python .proj/scripts/validate_architecture.py
...
Skills:
- workflow-testing - Test framework setup
- domain-security - Security patterns

Commands:
- the machine:2-run - Enforces ≥85% coverage requirement
- the machine:9-feedback - Quality improvement suggestions
