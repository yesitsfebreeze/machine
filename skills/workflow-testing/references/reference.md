...
from workflow_testing import DevelopmentWorkflow, WorkflowConfig
...
from workflow_testing import TDDManager, TestSpecification, TestType
...
from workflow_testing import AIDebugger
...
from workflow_testing import PerformanceProfiler
...
```bash
# CLI diagnostics
workflow diagnose --full-check
workflow test --dry-run --verbose
workflow profile --list-available
workflow review --show-rules

# Python diagnostics
from workflow_testing import diagnose
...
- Workflow logs: `.proj/logs/workflow.log`
- Test results: `.proj/test-results/`
- Profile data: `.proj/profiles/`
- Review reports: `.proj/reviews/`
- Debug sessions: `.proj/debug-sessions/`
...
- foundation-core - TRUST 5 framework and SPEC-First TDD
- domain-backend - Backend development workflows
- domain-frontend - Frontend development workflows
- platform-baas - Backend-as-a-Service integration
