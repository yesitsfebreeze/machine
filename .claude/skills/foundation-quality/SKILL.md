...
- foundation-core - TRUST 5 framework reference
- workflow-ddd - DDD workflow validation
- security-owasp - Security compliance
- context7-integration - Context7 best practices
- performance-optimization - Performance analysis

Commands:

- the machine:2-run - DDD validation integration
- the machine:3-sync - Documentation quality checks
- the machine:9-feedback - Quality improvement feedback
