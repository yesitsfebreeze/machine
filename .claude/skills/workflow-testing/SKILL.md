...
- domain-backend: Backend development workflows and API testing patterns
- domain-frontend: Frontend development workflows and UI testing strategies
- foundation-core: Core SPEC system and workflow management integration
- platform-supabase: Supabase-specific testing patterns and database testing
- platform-vercel: Vercel deployment testing and edge function validation
- platform-firebase-auth: Firebase authentication testing patterns
- workflow-project: Project management and documentation workflows
...
Maintained by: the machine Development Workflow Team
