...
decision = splitter.should_split(".claude/skillsthe machine-foundation-core/SKILL.md")
...
if decision["split_needed"]:
 ...
 ".claude/skillsthe machine-foundation-core",
...
# Usage
organizer = SkillOrganizer(".claude/skillsthe machine-foundation-core")
...
with open(".claude/skillsthe machine-foundation-core/NAVIGATION.md", 'w') as f:
 f.write(navigation)
```
...
# Usage
discovery = ModuleDiscovery(".claude/skillsthe machine-foundation-core")
...
- cc-skill-factory - Skill creation with modular structure
- foundation-token-optimization - File loading efficiency
...
Commands:
- the machine:1-plan - SPEC generation with modular docs
- the machine:3-sync - Documentation sync to modular structure

Memory:
- .claude/skills/ - Standard skill location
- Skill("foundation-core") modules/ - Memory files following modular pattern
