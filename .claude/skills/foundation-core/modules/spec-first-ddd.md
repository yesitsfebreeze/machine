...
SPEC-First DDD is the machine's development methodology combining:

1. SPEC Generation - EARS format requirements (the machine:1-plan)
2. Domain-Driven Development - ANALYZE-PRESERVE-IMPROVE (the machine:2-run)
3. Documentation Sync - Auto-generated docs (the machine:3-sync)

Three-Phase Workflow:
```
Phase 1: SPEC → spec-builder → .proj/specs/SPEC-XXX/spec.md
...
Skills:
- workflow-testing - Test frameworks

Commands:
- the machine:1-plan - SPEC generation (Phase 1)
- the machine:2-run - DDD implementation (Phase 2)
- the machine:3-sync - Documentation sync (Phase 3)
