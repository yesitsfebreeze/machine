...
- Core Principle: Machine delegates all work through Agent() calls
...
from foundation_core import TRUST5Validator
...
from foundation_core import SPECManager, DDDExecutor, DocsGenerator
...
from foundation_core import TaskAnalyzer, AgentRouter
...
from foundation_core import TokenMonitor, ContextOptimizer
...
trust check --all --verbose

# Token budget analysis
context analyze --show-breakdown

# Agent routing debug
agent route --task "description" --dry-run

# SPEC validation
spec validate SPEC-001 --format EARS
```

### Validation Utilities

```python
from foundation_core import diagnose
...
- TRUST 5 logs: `.proj/logs/trust5/`
- SPEC artifacts: `.proj/specs/`
- Agent execution logs: `.proj/logs/agents/`
- Token usage history: `.proj/logs/tokens/`
...
- the machine Documentation: See project README
...
- foundation-cc - Claude Code integration patterns
- workflow-project - Project management with core principles
- workflow-testing - Testing workflows with TRUST 5
- workflow-templates - Template management integration
