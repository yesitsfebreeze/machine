...
- `foundation-core`: Core execution patterns and SPEC workflow
- `foundation-context`: Token budget and session management
- `workflow-project`: Project initialization and configuration
